...
import com.example.fitnessfreaks.Activities.ExcersiceMain;
...
public class Em2ndFragment extends Fragment {
    View v;
    TextView inst,caution;
    DatabaseReference mdatabase;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.em2ndfragment,container,false);
        inst = (TextView)rootview.findViewById(R.id.emInst);
        caution = (TextView)rootview.findViewById(R.id.emCaution);
        return rootview;
    }
